...
<div class="menu"> 
    ...
    <button><a href="adminorder.jsp">Orders</a></button>
  <div class="dropdown">
  <br>
  <button  class="dropbtn2">Payments</button>
...
<div class="dropdown">
    <button class="dropbtn"><a href="adminorder.jsp">Orders</a></button>
...
try{ 
connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/mydatabase", "postgres","2112122");
...
Update Order Id: &nbsp<%=resultSet.getString("email") %>&nbsp
              ...
              <input type="hidden" name="oid" value="<%=resultSet.getString("email") %>">
&nbsp
...
<br>
  ...
  <table style="width:95%" id="<%=resultSet.getString("email") %>">
  <tr>
    <th>Order ID:</th>
    <th >Order Date:</th>
    <th >Ordered Item:</th>
