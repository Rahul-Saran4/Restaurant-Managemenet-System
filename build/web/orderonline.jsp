     ...
     <a style="font-size: 15px; color: #1e1e1e; font-family: arial; text-decoration: none;">HI! You are not logged in</a> <br/>
        ...
        <div class="form-style-5">
			...
			<select required id="job" name="type" size="1">
                                                            ...
                                                            <option value="hamburger">Hamburger   |    Price: ₹ 150</option>
                                                            <option value="cheeseburger">Cheeseburger   |    Price: ₹ 200</option>
                                                            <option value="doublecheeseburger">Double Cheeseburger   |    Price: ₹ 250</option>
